...
{	
	...
	//钢架初始参数
	public static float Pillar_init_w = 20f;            //钢架宽度
	public static float Pillar_init_h1 = 2f;            //钢架高度1
	public static float Pillar_init_h2 = 2f;            //钢架高度2
	public static float Pillar_init_jw = 0.6f;         //梁截面宽度
	public static float Pillar_init_jh = 0.2f;         //梁截面高度
